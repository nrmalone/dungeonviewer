...
-->
    <div style="margin-top: 55px;">
        ...
        <div class="pcDiv" style="max-width: 100%; max-height: 50%; padding-top: 10px;">
            <?php if (isset($_SESSION['userID']) && ($data['pcs'] == false || ($data['pcs'] != false && count($data['pcs']) < 10))): ?>
            <form method="POST">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <?php if (isset($_SESSION['userID']) && ($data['pcs'] == false || ($data['pcs'] != false && count($data['pcs']) < 10))) {
                                ...
                                elseif (is_countable($data['pcs']) && count($data['pcs']) >= 10) { echo '<h4 style="background-color: #1E1E1E; border: 1px white solid; border-radius: 10px 0 10px 0; padding: 5px 5px 5px 5px;">Maximum number<br>of characters<br>already created.</h4>'; }
                                elseif (!isset($_SESSION['userID'])) { echo '<h4 style="background-color: #1E1E1E; border: 1px white solid; border-radius: 10px 0 10px 0; padding: 5px 5px 5px 5px;">You must <a href="' . ROOT . 'account/signin" style="color: white; text-decoration: none; text-decoration: underline;">sign in</a><br> to save your <br>character sheet.</h4>'; } ?>
                        </td>
                    </tr>
                </table>
            </form>
