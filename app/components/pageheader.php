    ...
    <body>
        <header>            
            ...
            <?php if (isset($_SESSION['user_name'])) {
                echo '<h2 class="headerText"><a class="headerLink" href="' . ROOT . 'campaign" target="_blank">Campaign Info</a></h2>';
                echo '<h2 class="headerText"><a class="headerLink" href="' . ROOT . 'character" target="_blank">Character Sheet</a></h2>';
